  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        Widget myChild = content;       
        if (widget.sideBuilder != null && constraints.biggest.width > breakpoint) {
          myChild = Center(
        ...
        if (widget.headerBuilder != null) {
          double widthEditbox = MediaQuery.of(context).size.width > 500 ? 450 : 400;
          return Center (
            child: ConstrainedBox(
              constraints: BoxConstraints(
                maxWidth: widthEditbox,
              ),
              child : Padding(
